...
export default class PhoneInput extends Component {
  ...
  render() {
    ...
    const {
      textComponent, style, flagStyle, offset, textStyle, textProps, maxLength, pickerButtonColor, pickerButtonTextStyle,
      itemStyle, cancelText, cancelTextStyle, confirmText, confirmTextStyle, pickerBackgroundColor, pickerItemStyle
    } = this.props;
